...
// Découpage is now automatic (every incoming stack is split on ingest), so the
// slot no longer carries a group/explode/ask rule — only the consigne textarea
// that drives the auto-split and the adjust panel.
