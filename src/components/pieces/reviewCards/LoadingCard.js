...
export default function LoadingCard({ count }) {
  return (
    <CardShell>
      <CardIcon bg={colors.semantic.backgroundSubtle} color={colors.semantic.mutedForeground}><Loader2 className="w-3.5 h-3.5 animate-spin" strokeWidth={1.75} /></CardIcon>
