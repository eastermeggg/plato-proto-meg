  ...
  return (
    <div className="w-full" style={{ paddingRight: 16 }}>
      ...
      >
        ...
        {/* Footer */}
        <div className="flex items-center px-4 py-3 border-t border-border-subtle">
          <button
            onClick={onClose}
            className="text-[14px] text-foreground-secondary hover:text-foreground transition-colors"
          >
            Annuler
          </button>
        </div>
