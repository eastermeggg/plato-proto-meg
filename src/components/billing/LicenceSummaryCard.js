  ...
  return (
    <div className="bg-surface rounded-lg border border-border overflow-hidden">
            ...
            <div key={p.id} className={`flex-1 min-w-0 px-4 py-4 ${i < PRICING_PLANS.length - 1 ? 'border-r border-border' : ''}`}>
              <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <span style={{ fontFamily: "'RL Para Trial Central', Georgia, 'Times New Roman', serif", fontSize: '18px', fontWeight: 500, color: colors.semantic.foreground, letterSpacing: '-0.01em' }} className="truncate">
                    Plan {p.name}
                  </span>
                </div>
                <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontWeight: 500, fontSize: '11px', color: colors.semantic.mutedForeground, letterSpacing: '0.06em' }} className="uppercase whitespace-nowrap">
                  {QUOTA_LABEL[p.id]}
                </span>
              </div>
              ...
              <div className="flex items-baseline gap-1.5">
                <span style={{ fontFamily: "'RL Para Trial Central', Georgia, 'Times New Roman', serif", fontSize: '24px', fontWeight: 500, color: colors.semantic.foreground, letterSpacing: '-0.02em' }} className="tabular-nums">
                  {count}
                </span>
      ...
      <div className="flex items-center justify-between px-5 py-3.5 bg-background border-t border-border">
        <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontWeight: 500, fontSize: '11px', color: colors.semantic.mutedForeground, letterSpacing: '0.06em' }} className="uppercase">
          {totalLabel}
        </span>
        <p className="whitespace-nowrap">
          <span style={{ fontFamily: "'RL Para Trial Central', Georgia, 'Times New Roman', serif", fontSize: '30px', fontWeight: 400, color: colors.semantic.foreground, letterSpacing: '-0.02em' }} className="tabular-nums">
            {fmtEur(total)} €
          </span>
